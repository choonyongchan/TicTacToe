...
from tictactoe.agents.bns_agent import BNSAgent
from tictactoe.agents.bns_id_agent import BNSIDAgent
from tictactoe.agents.minimax_agent import MinimaxAgent
from tictactoe.agents.minimax_alphabeta_agent import MinimaxAlphaBetaAgent
from tictactoe.agents.minimax_rewards_alphabeta_agent import MinimaxRewardsAlphaBetaAgent
from tictactoe.agents.mc_informed_agent import MCInformedAgent
from tictactoe.agents.mc_puct_agent import MCPUCTAgent
...
from tictactoe.agents.mc_uct_forced_agent import MCUCTForcedAgent
from tictactoe.agents.mtdf_agent import MTDfAgent
from tictactoe.agents.mtdf_id_agent import MTDfIDAgent
from tictactoe.agents.negamax_agent import NegamaxAgent
from tictactoe.agents.negascout_agent import NegascoutAgent
...
AGENTS: dict[str, AgentFactory] = {
    # Exact search — solves the game, but only on boards small enough to solve.
    ...
    # Monte Carlo tree search — approximate, but keeps working as n grows.
    "mc_pure": lambda p, d: MCPureAgent(n_simulations=1600, seed=42),
    "mc_uct": lambda p, d: MCUCTAgent(n_simulations=1600, seed=42),
    "mc_uct_forced": lambda p, d: MCUCTForcedAgent(n_simulations=1600, seed=42),
    "mc_informed": lambda p, d: MCInformedAgent(n_simulations=1600, seed=42),
    "mc_rave": lambda p, d: MCRaveAgent(n_simulations=1600, seed=42),
    "mc_puct": lambda p, d: MCPUCTAgent(n_simulations=1600, seed=42),
}
