...
from tictactoe.heuristics.distance_heuristic import DistanceHeuristic
from tictactoe.heuristics.fork_heuristic import ForkHeuristic
from tictactoe.heuristics.heuristic import Heuristic
from tictactoe.heuristics.taxonomy_heuristic import TaxonomyHeuristic
from tictactoe.heuristics.threat_heuristic import ThreatHeuristic
from tictactoe.heuristics.window_scorer_heuristic import WindowScorerHeuristic
...
class TestHeuristic:
    ...
    def test_implements_base_heuristic(self):
        from tictactoe.heuristics.base_heuristic import BaseHeuristic
